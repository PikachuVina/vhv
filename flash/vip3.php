...
$resid = @mysqli_query($GLOBALS["___BMN_2312"], "SELECT * FROM `vip` WHERE `level` = 3"); 
$restk = @mysqli_query($GLOBALS["___BMN_2312"], "SELECT * FROM tokenvip ORDER BY RAND() LIMIT 0,100"); 
